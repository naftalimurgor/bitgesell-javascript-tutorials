...
function logRunSummary(logger) {
    ...
    if (errorCount) {
        logger.error(i18n.found_0_errors_and_1_warnings(errorCount.toString(), warningCount.toString()));
    }
    else if (warningCount) {
        logger.warn(i18n.found_0_errors_and_1_warnings(errorCount.toString(), warningCount.toString()));
    }
}
